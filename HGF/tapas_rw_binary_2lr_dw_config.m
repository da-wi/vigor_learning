function c = tapas_rw_binary_2lr_dw_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Alpha Reward
c.logitalrmu = tapas_logit(0.05, 1);
c.logitalrsa = 1;

% Alpha Loss
c.logitallmu = tapas_logit(0.05, 1);
c.logitallsa = 1;
...
c.prc_fun = @tapas_rw_binary_2lr_dw;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @tapas_rw_binary_2lr_dw_transp;
